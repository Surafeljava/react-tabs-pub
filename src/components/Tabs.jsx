    ...
    return (
        <div className='container'>
            ...
            <div className='tabs'>
                {
                    tabs.map((tab) => {
                        return (
                            <div key={tab.id} onClick={()=>setSelectedTab(tab)} className={(selectedTab.id===tab.id ? 'tab selected' : 'tab')}>
            ...
            <div className='tab-content'>
                ...
                <div className='tab-content-description'>{selectedTab.content}</div>
            </div>
        </div>
    );
}
